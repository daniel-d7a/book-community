...
function Post({ user, post }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "card max-w-2xl mx-auto w-full bg-base-100 shadow-xl mb-2", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex gap-4 items-center pt-4 pl-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "relative", children: [(0, jsx_runtime_1.jsx)("img", { src: user.profile, alt: "Shoes", className: " w-12 h-12 rounded-full object-cover" }), (0, jsx_runtime_1.jsx)("div", { className: `absolute bottom-0 right-0 w-5 h-5 rounded-full ${user.state === "r" ? "bg-teal-500" : "bg-yellow-500"}  text-black border-2 border-base-100 flex items-center justify-center text-[14px]`, children: user.state === "r" ? (0, jsx_runtime_1.jsx)(bi_1.BiBookReader, {}) : (0, jsx_runtime_1.jsx)(bi_1.BiEditAlt, {}) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "text-sm", children: [(0, jsx_runtime_1.jsxs)("a", { href: "#", children: [user.username || "user", " /", " ", (0, jsx_runtime_1.jsx)("a", { href: "#", children: post.community.length > 15
