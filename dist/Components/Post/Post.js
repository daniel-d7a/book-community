...
function Post({ user, post }) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { className: "rounded-md pb-4 bg-slate-950 max-w-lg mx-auto w-fullshadow-xl mb-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex gap-4 items-center pt-4 pl-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "relative", children: [(0, jsx_runtime_1.jsx)("img", { src: user && user.profile_photo
                                        ? user.profile_photo
                                        : "https://st3.depositphotos.com/6672868/13701/v/450/depositphotos_137014128-stock-illustration-user-profile-icon.jpg", className: " w-12 h-12 rounded-full object-cover" }), (0, jsx_runtime_1.jsx)("div", { className: `absolute bottom-0 right-0 w-5 h-5 rounded-full ${user.type === "r" ? "bg-blue-600" : "bg-yellow-500"}  text-black border-2 border-base-100 flex items-center justify-center text-[14px]`, children: user.type === "r" ? (0, jsx_runtime_1.jsx)(bi_1.BiBookReader, {}) : (0, jsx_runtime_1.jsx)(bi_1.BiEditAlt, {}) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "text-sm", children: [(0, jsx_runtime_1.jsx)("a", { href: "#", className: "text-lg font-bold", children: user.username || "user" }), post.community && "/", (0, jsx_runtime_1.jsx)("a", { href: "#", children: post.community && post.community.length > 15
                                        ? /* @ts-ignore */
                                            post.community.substring(0, 15) + "..."
                                        : /* @ts-ignore */
                                            post.community }), (0, jsx_runtime_1.jsxs)("div", { className: "flex gap-2 text-xs text-zinc-400", children: [(0, jsx_runtime_1.jsx)("p", { children: getDate(post.created_at) }), post.location && ((0, jsx_runtime_1.jsxs)("a", { href: "#", className: "flex gap-1 items-center", children: [(0, jsx_runtime_1.jsx)(tfi_1.TfiLocationPin, {}), " ", post.location] }))] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dropdown dropdown-end ml-auto mr-4", children: [(0, jsx_runtime_1.jsx)("label", { tabIndex: 0, className: "", children: (0, jsx_runtime_1.jsx)(bi_1.BiDotsHorizontalRounded, { className: "text-2xl" }) }), (0, jsx_runtime_1.jsxs)("ul", { tabIndex: 0, className: "dropdown-content menu p-2 shadow rounded-box w-52 bg-slate-950", children: [(0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsx)("a", { children: "Hide" }) }), (0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsx)("a", { children: "Report" }) }), (0, jsx_runtime_1.jsx)("li", { children: (0, jsx_runtime_1.jsx)("a", { children: "Copy Link" }) })] })] })] }), (0, jsx_runtime_1.jsx)("div", { className: "pl-4 pt-4", children: (0, jsx_runtime_1.jsx)("p", { children: post.text }) }), post.image && ((0, jsx_runtime_1.jsx)("figure", { className: "px-4 pt-4", children: (0, jsx_runtime_1.jsx)("img", { src: post.image, className: "" }) })), (0, jsx_runtime_1.jsxs)("div", { className: "flex gap-4 items-center px-4 py-2", children: [(0, jsx_runtime_1.jsxs)("p", { className: "flex gap-2 items-center", children: [(0, jsx_runtime_1.jsx)(bi_1.BiUpvote, { className: `${upVoted ? "text-blue-600" : "text-white"}`, onClick: () => {
                                        handleclick(1);
