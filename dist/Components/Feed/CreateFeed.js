...
function CreateFeed() {
  ...
  return (0, jsx_runtime_1.jsxs)("div", {
    className: "w-full bg-slate-950 h-fit mt-2 mb-6 rounded-md px-3 py-3",
    children: [
        ...
        children: [
          (0, jsx_runtime_1.jsx)("div", {
            ...
            children: (0, jsx_runtime_1.jsx)("img", {
              src: auth_1.auth.currentUser?.profile
                ? auth_1.auth.currentUser.profile
            ...
            children: (0, jsx_runtime_1.jsxs)("form", {
              ...
              children: [
                (0, jsx_runtime_1.jsx)("textarea", {
                  ...
                  className:
                    "focus:outline-none bg-slate-900 max-h-64 p-2 rounded-md h-28 resize-none transition-all w-full",
                }),
                (0, jsx_runtime_1.jsx)("div", {
                  className: "text-red-600",
                  children: errors.postText?.message,
                }),
      ...
      (0, jsx_runtime_1.jsxs)("div", {
        ...
        children: [
          (0, jsx_runtime_1.jsxs)("div", {
            className:
              "bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400",
            children: [
              (0, jsx_runtime_1.jsx)(bi_1.BiImage, {
          ...
          (0, jsx_runtime_1.jsxs)("div", {
            className:
              "bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400",
            children: [
              (0, jsx_runtime_1.jsx)(bi_1.BiVideo, {
          ...
          (0, jsx_runtime_1.jsxs)("div", {
            className:
              "bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400",
            children: [
              (0, jsx_runtime_1.jsx)(bi_1.BiCalendar, {
                className: "text-red-600",
              }),
              "Event",
            ],
          ...
          (0, jsx_runtime_1.jsxs)("div", {
            className:
              "bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400",
            children: [
              (0, jsx_runtime_1.jsx)(hi_1.HiEmojiHappy, {
