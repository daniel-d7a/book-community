...
function CreateFeed() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "w-full bg-slate-950 h-fit mt-2 mb-6 rounded-md px-3 py-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex gap-2", children: [(0, jsx_runtime_1.jsx)("div", { className: "w-10 h-10 rounded-full overflow-hidden shrink-0", children: (0, jsx_runtime_1.jsx)("img", { src: auth_1.auth.currentUser?.profile
