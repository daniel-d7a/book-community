...
function SignUp() {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "relative bg-slate-900 h-screen w-full flex items-center justify-center py-10 md:px-0", children: (0, jsx_runtime_1.jsxs)("div", { className: "md:w-2/5 bg-slate-950 rounded-lg flex flex-col items-center py-6 md:mr-10 px-6 mx-6 relative z-10 backdrop-blur-sm", children: [isLoading && (0, jsx_runtime_1.jsx)("p", { children: "Loading..." }), (0, jsx_runtime_1.jsx)("h2", { className: "text-3xl font-bold mb-2 md:text-center", children: "Sign Up" }), (0, jsx_runtime_1.jsxs)("p", { className: "font-light text-center mb-6", children: ["Already have an account?", " ", (0, jsx_runtime_1.jsx)("span", { className: "text-yellow-500 cursor-pointer", onClick: () => navigate("/login"), children: "Log In" })] }), (0, jsx_runtime_1.jsxs)("form", { onSubmit: handleSubmit(submitHandler), className: "space-y-4", children: [(0, jsx_runtime_1.jsx)("input", { type: "text", placeholder: "Email", className: "input input-bordered w-full py-6 rounded-sm bg-slate-900 focus:outline-none focus:border-yellow-500", ...register("email", { required: true }) }), (0, jsx_runtime_1.jsx)("input", { type: "text", placeholder: "User Name", className: "input input-bordered w-full py-6 rounded-sm bg-slate-900 focus:outline-none focus:border-yellow-500", ...register("username", { required: true }) }), (0, jsx_runtime_1.jsx)("input", { type: "password", placeholder: "Password", className: "input input-bordered w-full py-6 rounded-sm bg-slate-900 focus:outline-none focus:border-yellow-500", ...register("password", { required: true }) }), (0, jsx_runtime_1.jsx)("input", { type: "password", placeholder: "Confirm Password", className: "input input-bordered w-full py-6 rounded-sm bg-slate-900 focus:outline-none focus:border-yellow-500", ...register("confirmPassword", { required: true }) }), (0, jsx_runtime_1.jsx)("div", { className: "form-control mb-0", children: (0, jsx_runtime_1.jsxs)("label", { className: "label cursor-pointer", children: [(0, jsx_runtime_1.jsx)("span", { className: "label-text", children: "Writer" }), (0, jsx_runtime_1.jsx)("input", { type: "radio", className: "radio checked:bg-yellow-500", checked: true, value: "w", ...register("type") })] }) }), (0, jsx_runtime_1.jsx)("div", { className: "form-control mt-0", children: (0, jsx_runtime_1.jsxs)("label", { className: "label cursor-pointer", children: [(0, jsx_runtime_1.jsx)("span", { className: "label-text", children: "Reader" }), (0, jsx_runtime_1.jsx)("input", { type: "radio", className: "radio checked:bg-blue-500", value: "r", ...register("type") })] }) }), (0, jsx_runtime_1.jsx)("button", { type: "submit", className: "text-lg font-semibold rounded-sm w-full py-3 bg-yellow-500", children: "Sign Up" })] })] }) }));
}
