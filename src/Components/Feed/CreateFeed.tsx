  ...
  return (
    <div className="max-w-2xl mx-auto w-full bg-slate-950 h-fit mt-2 mb-6 rounded-md px-3 py-3">
          ...
          <div className="flex flex-wrap gap-2">
              <div className="bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400"><BiImage className="text-green-600"/>Photo</div>
              <div className="bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400"><BiVideo className="text-blue-600"/>Video</div>
              <div className="bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400"><BiCalendar className="text-red-600"/>Event</div>
              <div className="bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400"><HiEmojiHappy className="text-yellow-500"/>Feeling /Activity</div>
              <div className="bg-slate-900 px-2 py-1 rounded-md flex items-center gap-1 text-gray-400">...</div>
            </div>
