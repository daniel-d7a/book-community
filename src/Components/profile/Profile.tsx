...
export default function Profile() {
  ...
  return (
    <div className="bg-slate-900 min-h-screen mb-0 overflow-hidden">
      <Nav />
        ...
        {status === "success" && (
          <>
            <div className="w-full bg-slate-950 mb-4 max-w-lg md:mx-auto pt-20 pb-4 relative rounded-md overflow-hidden">
              <div
                className={`w-full h-36 absolute top-0 z-0 left-0 ${
                  data?.type === "r" ? "bg-blue-600" : "bg-yellow-500"
                }`}
              >
                <div
                  className={`text-9xl  flex items-center ${
                    data?.type === "w"
                      ? "justify-start text-yellow-900"
                      : "justify-end text-blue-900"
                  }`}
                >
              ...
              <div className="flex w-full z-20 flex-col gap-4 relative items-center">
                <img
                  ...
                  className="w-28 h-28 rounded-full object-cover border-white border-[3px]"
                  alt=""
                />
                ...
                {params.user_id === auth.currentUser?.uid && (
                  <div className="flex gap-4">
                    <button className="p-2 px-4 flex items-center gap-1 rounded-md bg-yellow-950 text-yellow-500 text-sm md:text-base">
                      Edit profile
                      <BiPencil className="text-xl" />
                    </button>
                    <button className="p-2 px-3 rounded-md text-lg flex items-center justify-center bg-slate-900">
