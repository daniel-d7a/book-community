        ...
        <div
          className={`absolute ${
            type === "c"
              ...
              : "-bottom-1 right-0 w-3 h-3 text-[6px]"
          }  rounded-full ${
            state === "r" ? "bg-teal-500" : "bg-yellow-500"
          }  text-black border-2 border-base-100 flex items-center justify-center`}
        >
